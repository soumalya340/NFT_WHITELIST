...
import "./@rarible/contracts/IERC2981.sol";
...
contract NFT is ERC721, Ownable, IERC4907 {
    ...
    bytes private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;
    ...
    function setRoyalties(
        ...
        _royalties[1].value = _royaltiesReceipientAddress;
        _saveRoyalties(_tokenId, _royalties);
    }

    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721) returns (bool) {
    if(interface == LibRoyalties2981_INTERFACE_ID_ROYALTIES)
        return true;
    if(interface == _INTERFACE_ID_ERC2981)
       return true;
